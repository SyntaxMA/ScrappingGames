    ...
    public void run() {
        ...
        for (WebElement juegoElement : juegoElements) {
            ...
            try {
                ...
                nombre = juegoElement.findElement(new By.ByClassName("ta14b t11")).getText();
                imagen = juegoElement.findElement(new By.ByClassName("mb05 imgabsoluta")).getAttribute("src");
                fecha = juegoElement.findElement(new By.ByClassName("w100 t11")).getText();
                plataformas = juegoElement.findElement(new By.ByClassName("color83")).getText();
                descripcion = juegoElement.findElement(new By.ByClassName("mt05")).getText();
